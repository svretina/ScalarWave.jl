...
@testset "gf_base_isapprox" begin
    a = ScalarWave.GridFunctions.GridFunction([0,1,2], [0,0,0])
    b = ScalarWave.GridFunctions.GridFunction([0,1,2], [0,0,0])
    @test isapprox(a,1e-16, atol=1e-15)
    @test isapprox(1e-16, a, atol=1e-15)
    @test isapprox(a, b, atol=1e-15)
    c = ScalarWave.GridFunctions.GridFunction([0,1,2], [1e-16,1e-16,1e-16])
    @test isapprox(a, c, atol=1e-15)
    d = ScalarWave.GridFunctions.GridFunction([0,1,3], [0,0,0])
...
@testset "gf_base_equality" begin
    ...
    @test a == 0
    @test 0 == a
    c = ScalarWave.GridFunctions.GridFunction([0,1,3], [0,0,0])
...
@testset "gf_base_inequality" begin
    a = ScalarWave.GridFunctions.GridFunction([0,1,2], [0,0,0])
    b = ScalarWave.GridFunctions.GridFunction([0,1,2], [1,2,3])
    @test a != b
    @test b != a
    @test a.y != b.y
    @test a != 1
...
@testset "gf_base_addition" begin
    ...
    c = 1+a
    d = a+a
    e = ScalarWave.GridFunctions.GridFunction([0,1,2], [1,1,1])
    @test b == e
    @test a == a+0
    @test a == 0+a
    @test a == a+a
...
@testset "gf_base_substraction" begin
    a = ScalarWave.GridFunctions.GridFunction([0,1,2], [1,1,1])
    b = a-1
    c = 1-a
    d = a-a
    e = ScalarWave.GridFunctions.GridFunction([0,1,2], [0,0,0])
    @test b == e
    @test a == a-0
    @test -a == 0-a
    @test d == e
...
@testset "gf_base_multiplication" begin
    a = ScalarWave.GridFunctions.GridFunction([0,1,2], [1,1,1])
    b = ScalarWave.GridFunctions.GridFunction([0,1,2], [1,1,1])
...
@testset "gf_base_sin" begin
    y = [1,2,3]
    a = ScalarWave.GridFunctions.GridFunction([0,1,2], y)
    @test sin(a) == sin.(y)
end
...
@testset "gf_base_asin" begin
    y = [0.1, 0.5, 0.8, 1]
    a = ScalarWave.GridFunctions.GridFunction([0,1,2,3], y)
    @test asin(a) == asin.(y)
end
