...
function decompose!(coefs::AbstractArray, func::Function, time_grid::Array{<:AbstractFloat}, radius::Real, lmax::Int)
...
function decompose!(coefs::AbstractArray, func::Function, time_instance::Real, spatial_grid::Array{<:AbstractFloat}, lmax::Int)
